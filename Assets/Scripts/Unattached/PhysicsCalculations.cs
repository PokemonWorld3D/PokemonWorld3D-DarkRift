...
{
    public static bool IsGrounded(Collider collider, float errorMargin, float colliderRadius)
    {
        return Physics.CheckCapsule(collider.bounds.center, new Vector3(collider.bounds.center.x, collider.bounds.min.y - errorMargin, collider.bounds.center.z), colliderRadius);
    }
